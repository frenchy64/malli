...
(def ConstraintExtension
  [:map
   ...
   [:unparse-properties
    [:-> Properties Constraint Properties Options]]
...
;(m/=> mce/get-constraint-extension [:-> [:maybe ConstraintExtension] :any])
;(m/=> mce/register-constraint-extensions! [:-> ConstraintExtensions ConstraintExtensions])
;(m/=> mc/base-constraint-extensions [:-> ConstraintExtensions])
;(m/=> mc/base-constraints [:-> ConstraintExtensions])
